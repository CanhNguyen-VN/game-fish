...
playerLeft.src = "./images/fishLeft.png";
const playerRight = new Image();
playerRight.src = "./images/fishRight.png";
class Player {
  constructor() {
    this.x = canvas.width;
...
bubbleImage.src = "./images/bubble1.png"
class Bubble {
  constructor() {
...
bubblePop2.src = "./audio/sound2.ogg";
...
class Enemy {
    ...
    draw() {
        ...
        ctx.arc(this.x, this.y,this.radius,0, Math.PI*2)
        ctx.fill() */
        ctx.drawImage(enemyImage,this.frameX*this.spriteWidth,this.frameY*this.spriteHeight,this.spriteWidth,this.spriteHeight, this.x - this.radius,this.y-this.spriteHeight/7,this.spriteWidth/4,this.spriteHeight/4)
    }
    update(){
        this.x -=this.speed;
...
function handleGameOver (){
    ctx.fillStyle = "white"
    ctx.fillText("GAME OVER, your reached score "+ score,110,250)
    gameOver = true
}
//animation loop
function animate() {
